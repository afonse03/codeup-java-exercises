...
//    public static boolean sameCase(String x, String y) {
//        for(int i = 0; i < x.length(); i++) {
//            boolean hasUpperCase = x.equals(x.toUpperCase());
//            boolean hasLowerCase = x.equals(x.toLowerCase());
//            boolean hasUpperCase2 = y.equals(y.toUpperCase());
//            boolean hasLowerCase2 = y.equals(y.toLowerCase());
//
//            if(!hasUpperCase == hasUpperCase2) return false;
//            if(!hasLowerCase == hasLowerCase2) return false;
//        }
//        return true;
//    }
//
//    /* use these test cases from Matthew to test your code for #10:
//
...
////    public static String combineChars(char one, char two) {
////        int charOne = Character.compare(one, two) {
...
//        System.out.println(combineChars('A', 'B'));
//        System.out.println(combineChars('2', 'b'));
//    }
//
//
//}
