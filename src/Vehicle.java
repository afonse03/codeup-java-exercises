...
Bonus: create a findVehicle method. the findVehicle method should be part of the Garage class. It takes a string and an array of Vehicles. It returns the vehicle that the customer is looking for (the vehicle the name of which matches the string). If the vehicle is not in the garage, it returns a Vehicle with a null name.
 */
